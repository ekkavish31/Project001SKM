...
(function(){
  ...
  function serializeBlob(){
    ...
    // ChangeRecord (carry over + appended)
  ...
  var Store = {
    ...
    saveToExcel: async function(){
      ...
      if(DB.fileHandle && await ensurePerm(DB.fileHandle,"readwrite")){
        ...
        DB.dirty=false; cache(); return { ok:true, mode:"file", name:DB.fileName };
      }
    ...
    addEmployee: function(p){
      ...
      recomputeDerived(); afterChange(); return p;
    },
